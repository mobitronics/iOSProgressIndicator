...
@interface MTInitialProgressLayer : CALayer
...
@implementation MTInitialProgressLayer
...
@interface MTInitialProgressView ()

@end

@implementation MTInitialProgressView

+ (void) initialize
{
  if (self == [MTInitialProgressView class]) {
    MTInitialProgressView *circularProgressViewAppearance = [MTInitialProgressView appearance];
    [circularProgressViewAppearance setTrackTintColor:[[UIColor grayColor] colorWithAlphaComponent:0.3f]];
    [circularProgressViewAppearance setProgressTintColor:[UIColor redColor]];
...
+ (Class)layerClass
{
  return [MTInitialProgressLayer class];
}

- (MTInitialProgressLayer *)circularProgressLayer
{
  return (MTInitialProgressLayer *)self.layer;
}
...
- (void)progressChange
{
  CGFloat progress = ![self.timer isValid] ? 1.0 / 10.0f : self.progress + 0.01f;
